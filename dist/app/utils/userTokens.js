...
const createUserTokens = (user) => {
    ...
    const accessToken = (0, jwt_1.generateToken)(jwtPayload, env_config_1.envVars.JWT_ACCESS_SECRET, env_config_1.envVars.ACCESS_EXPIRES_IN);
    const refreshToken = (0, jwt_1.generateToken)(jwtPayload, env_config_1.envVars.JWT_REFRESH_SECRET, env_config_1.envVars.REFRESH_EXPIRES_IN);
    return {
        accessToken,
        refreshToken
    };
...
const createNewAccessTokenWithRefreshToken = (refreshToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (isUserExist.status === user_interface_1.AccountStatus.BLOCKED || isUserExist.status === user_interface_1.AccountStatus.SUSPENDED) {
