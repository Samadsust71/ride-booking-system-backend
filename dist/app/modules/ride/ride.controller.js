...
const feedbackRide = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const rideId = req.params.id;
    const rider = req.user;
    const { userId: riderId } = rider;
    const { rating, feedback } = req.body;
    const result = yield ride_service_1.RideService.feedbackRide(rideId, riderId, rating, feedback);
    (0, sendResponse_1.sendResponse)(res, {
        success: true,
        statusCode: http_status_codes_1.default.OK,
...
const findNearbyDrivers = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const payload = req.body;
    const result = yield ride_service_1.RideService.findNearbyDrivers(payload);
    (0, sendResponse_1.sendResponse)(res, {
        success: true,
        statusCode: http_status_codes_1.default.OK,
