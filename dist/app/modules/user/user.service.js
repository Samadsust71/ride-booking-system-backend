...
const createUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const hashedPassword = yield bcryptjs_1.default.hash(password, Number(env_config_1.envVars.SALT_VALUE));
    const authProvider = {
...
const updateUser = (userId, payload, decodedToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (payload.password) {
        payload.password = yield bcryptjs_1.default.hash(payload.password, Number(env_config_1.envVars.SALT_VALUE));
    }
