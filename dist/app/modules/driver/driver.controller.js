...
const applyToBeDriver = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, sendResponse_1.sendResponse)(res, {
        ...
        message: "Request for driver submitted successfully.",
        data: driver,
    });
}));
...
const getEaringHistory = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = req.user;
    const { userId } = user;
    const result = yield driver_service_1.DriverService.getEaringHistory(userId);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: http_status_codes_1.default.OK,
        success: true,
